...
import {readInputs, ReadInputsOutput} from '../../../data/read-inputs';
...
export const VirGame = defineElement<GameInputs>()({
    ...
    initCallback: ({inputs, state, updateState, dispatch, events, genericDispatch}) => {
